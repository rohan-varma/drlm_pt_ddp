...
python dlrm_s_pytorch.py --use-gpu --print-time --dist-backend nccl --nepochs 2 --data-size 2048 --mini-batch-size 2 --debug-mode --arch-sparse-feature-size 2 --node-world-size ${SLURM_NTASKS} --rank ${SLURM_PROCID} --grpc True
